...
/**
 * Created by aloha on 04-Jun-16.
 */
public class MarkLogicStrings {

    /*ONE DOC THAT HOLDS ALL USERS*/
    public static String USERS_DOC_ID="/users.xml";
    public static String USERS_COL_ID="userscoll";


    // Collection IDs for database.
